...
function Home() {
  ...
  const [weather, setWeather] = useState({
    // nhớ tạo giá trị khởi tạo giống với dữ liệu thật
  ...
  return (
    <div>
      ...
      <img
        ...
        alt="sunny"
      />
      <Button onClick={() => setCity("saigon")} variant="primary">
        HCM
      </Button>
      <Button onClick={() => setCity("london")} variant="primary">
        London
      </Button>
      <Button onClick={() => setCity("tokyo")} variant="primary">
        Tokyo
      </Button>
      <Button onClick={() => setCity("hanoi")} variant="primary">
        HN
      </Button>
    </div>
  );
